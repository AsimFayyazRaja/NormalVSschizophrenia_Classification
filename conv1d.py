...
import keras
from keras.layers import Input, Dense, Flatten,Activation, Reshape,BatchNormalization,Conv1D, MaxPooling2D
...
resh=Reshape((240,480))(flat)

conv=Conv1D(filters=32,kernel_size=3)(resh)
