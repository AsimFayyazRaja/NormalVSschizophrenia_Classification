...
import keras
from keras.layers import Input, Dense,Dropout, Flatten, Reshape, Conv2D, MaxPooling2D
...
resh=Reshape((120,120,8))(flat)

conv=Conv2D(kernel_size=3,filters=32)(resh)
conv=MaxPooling2D()(conv)

conv=Conv2D(kernel_size=3,filters=64)(conv)
conv=MaxPooling2D()(conv)

conv=Conv2D(kernel_size=3,filters=128)(conv)
conv=MaxPooling2D()(conv)

conv=Conv2D(kernel_size=3,filters=256)(conv)
conv=MaxPooling2D()(conv)
